...
class __TwigTemplate_4d1bf6f36aa49e62465e1aab7f0e7698bc5519df11dee710f31fbb7fa2e816a1 extends Twig_Template
{
   ...
   ";
        ...
        $context['_seq'] = twig_ensure_traversable((isset($context["veze"]) ? $context["veze"] : $this->getContext($context, "veze")));
       ...
       ";
            // line 12
            $context["e"] = (isset($context["item"]) ? $context["item"] : $this->getContext($context, "item"));
            // line 13
            echo "     
       ";
            // line 14
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["item"]) {
                // line 17
                echo "           ";
                if (((isset($context["x"]) ? $context["x"] : $this->getContext($context, "x")) == true)) {
                    // line 18
                    echo "               <div class=\"vlasnik\">
            <p><b>Owner:</b>";
                    // line 19
                    echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute((isset($context["item"]) ? $context["item"] : $this->getContext($context, "item")), "veze"), "vlasnik"), "html", null, true);
                    echo " </p> 
            <p><b>Visibility:</b>";
                    // line 20
                    echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute((isset($context["item"]) ? $context["item"] : $this->getContext($context, "item")), "veze"), "vidljivost"), "html", null, true);
                    echo " </p> 
          
            
            <p><input type=\"checkbox\" name=\"box[]\" value=\"";
                    // line 23
                    echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute((isset($context["item"]) ? $context["item"] : $this->getContext($context, "item")), "veze"), "idveza"), "html", null, true);
                    echo "\"></p>
               </div>
             ";
                    // line 25
       ...
       ";
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["item"]) {
                // line 31
                echo "        <tr><td>";
                echo twig_escape_filter($this->env, $this->getAttribute((isset($context["item"]) ? $context["item"] : $this->getContext($context, "item")), "vrstapolja"), "html", null, true);
                echo "</td>
            <td>";
                // line 32
                echo twig_escape_filter($this->env, $this->getAttribute((isset($context["item"]) ? $context["item"] : $this->getContext($context, "item")), "podnaziv"), "html", null, true);
                echo " </td>
            <td>";
                // line 33
                echo twig_escape_filter($this->env, $this->getAttribute((isset($context["item"]) ? $context["item"] : $this->getContext($context, "item")), "podnaziv2"), "html", null, true);
                echo " </td> 
            <td>";
                // line 34
                echo twig_escape_filter($this->env, $this->getAttribute((isset($context["item"]) ? $context["item"] : $this->getContext($context, "item")), "sadrzajpolja"), "html", null, true);
                echo " </td> </tr>
